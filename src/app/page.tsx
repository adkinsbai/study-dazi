  ...
  return (
    <div className="min-h-screen bg-[#fef7f5] bg-stripe relative overflow-hidden page-enter">
      ...
      <div className="fixed inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute bottom-40 left-1/4 w-40 h-40 rounded-full bg-[#8b5cf6]/[0.04] blur-2xl"></div>
        <div className="absolute bottom-20 right-1/3 w-64 h-64 rounded-full bg-[#6366f1]/[0.03] blur-2xl"></div>
      </div>
