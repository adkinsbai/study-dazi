...
import { BookOpen, Users, Handshake, MessageCircle, Bell, Settings, LogOut, Sparkles, Search, Trash2, Key, Rocket, Flame, ChevronRight, GraduationCap } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
          ...
          {user ? (
            <nav className="flex items-center gap-1 sm:gap-2" role="navigation" aria-label="主导航">
              ...
              <div className="relative inline-flex group/tip">
                <Link href="/settings" className="p-1.5 rounded-full text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors"><Settings size={16} /></Link>
              ...
              <div className="relative inline-flex group/tip">
                <button onClick={logout} className="p-1.5 rounded-full text-gray-400 hover:bg-gray-100 hover:text-gray-600 transition-colors"><LogOut size={16} /></button>
